...
Project of [Getting and Cleaning Data course on Coursera](https://www.coursera.org/course/getdata), Nov 2016 edition.
...
* __Tidy.csv__: Tidy data set in .csv format
* __Tidy.txt__: Tidy data set in .csv format
